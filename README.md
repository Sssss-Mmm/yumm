...
| M3 | 매칭/해체 알림, 식사 당일 리마인드 | 스케줄러 분리만 완료 — 이메일 발송 수단 확보가 선행 조건이고, 남은 알림 4종이 전부 여기에 묶여 있다 |
| M4 | 신고·차단·성인 인증·약관 동의·안전 수칙, 2인 폴백, 관리자 신고 처리 | 진행 중 — 이탈자 채팅 구독 해제(FR-T-02)와 약관 본문(NFR-09)이 남음 |
| M5 | 1개 지역 클로즈드 베타 | 예정 |
